 ...
 */
class EntityMaintenanceConverter implements ParamConverterInterface
{
    /**
     * Aliases for entity
     */
    ...
    /**
     * EntityMaintenanceConverter constructor.
    ...
    public function apply(Request $request, ParamConverter $configuration)
    {
        if (!array_key_exists($request->get('entity'),self::ENTITY_ALIAS)){
            throw new LogicException('You cannot create new maintenance from wrong entity.');
        }
    ...
    {
        return $configuration->getClass() === EntityWithMaintenanceInterface::class;
    }
}
