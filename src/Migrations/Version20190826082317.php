 ...
 */
final class Version20190826082317 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE room ADD width VARCHAR(255) DEFAULT NULL, ADD height VARCHAR(255) DEFAULT NULL, ADD depth VARCHAR(255) DEFAULT NULL, ADD paint_color VARCHAR(255) DEFAULT NULL, ADD note VARCHAR(255) DEFAULT NULL, ADD photo VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE room DROP width, DROP height, DROP depth, DROP paint_color, DROP note, DROP photo');
    }
}
